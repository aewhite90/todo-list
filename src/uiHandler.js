...
const cancelEntry = (e) => {
  if (e.target.id === "project-cancel" || e.target.id === "project-add") {
    document
      .querySelector(".user-defined-projects")
      .removeChild(document.querySelector(".input-item"));
  } else {
    document
      .querySelector(".task-list")
      .removeChild(document.querySelector(".task-form"));
  }
};
